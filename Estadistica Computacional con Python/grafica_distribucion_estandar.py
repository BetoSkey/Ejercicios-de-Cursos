import random
from formulas_estadisticas import ordenamiento_insercion, media, desviacion_estandar, valores_x_y_distribucion_normal
...
sigma: {round(desviacion_estandar(lista),2)}
