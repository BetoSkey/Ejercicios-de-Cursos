...
class Datos_estadisticos:
    ...
    def __init__(self, muestra=True, **kwargs):
        accepted_kwargs = [
            'fecha_registro', 'titulo', 'descripcion', 'datos', 'fecha_inicial_datos',
...
if '__main__' == __name__:
    ...
    datos2 = Datos_estadisticos(datos={'Diva': 28, 'Gilberto': 42, 'Jessica': 27, 'Connie': 30}, muestra=True, fecha_registro='2021-03-10', titulo='Edades de compradores',
    ...
    datos3 = Datos_estadisticos(datos=[30, 59, 200, 29, 234, 33], fecha_registro='2021-03-10',
